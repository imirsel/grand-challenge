...
<div id="wrapper">
	<div id="content">
        ...
        <div id="main">
		  ...
		  usability experience challenge (GC15UX)</a>
	        </li>
	    ...
	    <p>
	      For the second year of the MIREX Grand Challenge the
	      ...
	      track to some video footage.
            ...
            <p>
              For more details see the <a href="/mirex/wiki/2015:GC15UX">Call
	   ...
	   <p>
               In order to become an evaluator for MIREX GC15UX, there are
	   ...
	   <h2>Get the Data</h2>
	   <p>
		All participating GC15UX systems must use the GC15UX song dataset.
		The dataset can be downloaded once you are logged-in as a submitter under the "Download dataset" link.
           ...
           <p>
               In order to submit an entry into MIREX GC15UX, there are
	       two steps to complete: first 
	       <a href="register.php">register</a>
               (if you do not already have an account at the MIREX site)
	       then proceed to 
	   ...
	   <p>The registration process for GC15UX is based on the one developed for MIREX.
	   ...
	   <p>
	    ...
	    <p>
	      ...
	      system you are entering into GC15UX.  For example, ...
