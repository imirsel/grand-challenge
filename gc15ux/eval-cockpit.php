...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <title>MIREX Grand Challenge 2015 Usability Experience</title>
...
*/
      ...
      #eval-system-div {
        ...
        background: url('http://www.music-ir.org/gc15ux-ex/interfaces/therin/img/bg.png') repeat scroll 0% 0% #A8C8CA;
...
used to be 63px */
  ...
  <body>
      ...
      <div id="main-content">
        <div id="side-by-side">
            <ol>
		      ...
		      <iframe src="http://www.music-ir.org/gc15ux-ex/thankyou-library/collection/basic-implementation-biased/page/about" 
	...
	<div style="float: left" ><h2 class="GC-Title">GC15UX</h2></div>
