...
$MIREX_year = '2015';
$MIREX_absdir = '/nema-raid/www/mirex/abstracts/' . $MIREX_year . '/';
...
function generateHashChecksum($hash)
{
  $salt = "1415926535897932384626433832";
  $hash_md5 = md5($hash);
  return sha1($salt . $hash_md5);
}
...
function getSubmissionSubTasks($sub_task)
{
...
##	error_log("*** getSubmissionsBySubTask($sub_task): SQL = $sql");
...
function getSubmissionUser($user, $id) {
	...
	if ($user != NULL) {
		$sql = "SELECT 
						...
						s.sub_Hashchecksum as hashchecksum,
