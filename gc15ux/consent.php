<?php
	...
	*/
	...
	$consent = userHasGivenGCConsent($loggedInUser);

	if (empty($consent) &&
		isset($_POST['consent_Sign']) &&
		($_POST['consent_Sign'] == 'Y'))
	{
		userGiveGCConsent($loggedInUser);
...
<div id="wrapper">
	<div id="content">
			...
			(isset($consent['consent_UserAgent'])))
		{
			...
			<h2>Evaluating User Experience of MIR Systems</h2>
			<h3>Investigators</h3>
			<i>
			Responsible Project Investigator:
				J. Stephen Downie (jdownie@illinois.edu)

			</i>

  <p>You are invited to participate in the MIREX grand challenge about
  evaluating user experiences of MIR systems. The goals of this grand
  challenge are to inspire the development of complete MIR systems and
  to promote the notion of user experience as a first-class research
  objective in the MIR community. You will be asked to find some songs
  to use as background music for an imaginary video about a recent
  memorable occasion. Your assistance will help future researchers and
  developers build better and more useful music retrieval systems that
  better meet the needs of real users.</p>


  <p>Your participation as an evaluator is completely voluntary. If you
  come to any selections you do not want to evaluate, please feel free
  to skip to the next selection. You may also start and stop your
  evaluating sessions, and modify your judgments as you see fit, up to
  21 Oct 2014 when we will be closing the collection process. You
  may discontinue participation at any time, including after the
  completion of the evaluating, for any reason. In the event that you
  chose to stop participation, you may ask us to have your answers
  deleted by contacting us through email prior to 21 Oct 2014 when
  we will be aggregating the collected data.</p>

  <p>All personally identifying information of the evaluators, however
  obtained, (e.g., name, company of employment, place of residence,
  names of collaborators, email addresses, website URL, response
  times, etc.) will be kept confidential, meaning accessible by only
  the investigators and not published nor shared with other
  researchers. The original raw evaluator scores will not be
  distributed nor disseminated beyond the investigators and will be
  kept locked in a University office and on restricted access (i.e.,
  password- protected) areas of the investigators’ computers. Data
  will be retained until the end of IMIRSEL’s active involvement in
  MIR/MDL evaluations, for a minimum of three years after its
  collection and as long as is necessary to complete the necessary
  analyses of the data.</p>


<h3>Benefits of Participation</h3>

  The sharing of your knowledge of how you perceive your experience
	  with the systems will contribute to a fuller understanding
	  of the user experience in interacting with complete MIR
	  systems, and also aid in the development of MIR systems that
	  could better meet real users’ needs.</p>

<h3>Risks of Participation</h3>

<p>Participation as a grader does not involve risks beyond those
   encountered in daily life.</p>

<h3>Time Commitment</h3>

<p>Evaluation of a single MIR system takes approximately 20-30
	  minutes. You can stop at any time and resume grading,
	  allowing you to complete the entire process in stages.</p>

<h3>Contact Information</h3>

  <p>If you have any questions or concerns about this study, please
  contact the investigators. Project contact address c/o:</p>


  <p>Dr. J. Stephen Downie, Graduate School of Library and Information
  Science, 501 E. Daniel St., Champaign, IL 61820; phone:
  217-265-5018, fax: 217-244-3302.</p>

  <p>If you have any questions about your rights as a participant in this
  study or any concerns or complaints, please contact the University
  of Illinois Institutional Review Board at 217-333-2670 (collect
  calls will be accepted if you identify yourself as a research
  participant) or via email at irb@illinois.edu.</p>

<!--
<p>YOU MUST BE 18 YEARS OF AGE OR OLDER TO PARTICIPATE!</p>

<p>
  I certify that I am 18 years of age or older, I can print out a copy
  of this consent form, I have read the preceding and that I
  understand its contents. By selecting “I Agree” below I am freely
  agreeing to participate in this study by filling out the survey.</p>
-->
...
OLD STUFF
			...
			<p>Your participation as a grader is completely voluntary. If you come to any selections you do not want to grade, please feel free to skip to the next selection. You may also start and stop your grading sessions, and modify your judgments as you see fit, up to September (DEADLINE), 2012  when we will be closing the collection process. You may discontinue participation at any time, including after the completion of the grading, for any reason. In the event that you chose to stop participation, you may ask us to have your answers deleted by contacting us through email prior to September (DEADLINE), 2011 when we will be aggregating the collected data.</p>
...
-->
			...
			<h3>YOU MUST BE 18 YEARS OF AGE OR OLDER TO PARTICIPATE!</h3>
